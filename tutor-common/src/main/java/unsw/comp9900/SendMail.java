...
public class SendMail {
    ...
    public static String sendEmailAccount = "z917975141@gmail.com";
    // 发件人的邮箱的授权码(自己在邮箱服务器中开启并设置)
    public static String sendEmailPassword = "kkssazjfkmhiudyk";
...
//    public static String receiveMailAccount = "xxx@qq.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,
        ...
        // 设置发件人姓名和编码格式
        message.setFrom(new InternetAddress(sendMail, "Email verification system"));

        // 收件人
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "Dear User"));
